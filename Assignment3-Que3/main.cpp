...
protected:
    ...
    int index;  // to maintain the index of callHistory array.
    int size1; // size of call history
    int size2;// size of phonebook
    int startingIndex; // starting index of callHistory
...
public:
    ...
    void callFromHistory(){
        ...
        if(startingIndex+choice<20){
            call(callHistory[startingIndex+choice-1]); //call funtion called.
